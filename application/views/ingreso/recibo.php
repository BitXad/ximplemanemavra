...
<td style="padding: 0;">
            ...
            <table class="table" style="width: <?php echo $ancho;?>cm; padding: 0;" >
                    ...
                    <td style="width: <?php echo 5;?>cm;  padding: 0; line-height: 12px;">
                        <center>            
                            ...
                            <br>
                                ...
                                <font size="3" face="arial"><b>Nº:  00<?php echo $ingresos[0]['ingreso_id']; ?> </b></font>                       
                ...
                <?php $fecha = new DateTime($ingresos[0]['ingreso_fecha']); 
        ...
        <tr>
            <td style="line-height: 8px;" colspan="2"> 
                    ...
                    <center>
                        ...
                        <?php echo "-----------------------------------------------------"; ?><br>
                        <?php echo "RECIBI CONFORME"; ?><br><?php echo$ingresos[0]['usuario_nombre'];?>
