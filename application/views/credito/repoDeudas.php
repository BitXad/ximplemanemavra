...
<div class="row">  
    ...
    , 'proveedor_telefono' => $t['proveedor_telefono'], 'proveedor_telefono2' => $t['proveedor_telefono2'], 'credito_cancelado' => $cancelado);
                        ...
                        <td style="text-align: center;"><?php echo $c['proveedor_nombre']; ?></td>                                                
                        ...
                        <td style="text-align: center;"><?php echo $c['proveedor_telefono']; ?><?php if($c['proveedor_telefono2']!=NULL && $c['proveedor_telefono2']!=NULL){ ?> - <?php echo $c['proveedor_telefono2'];} else { echo $c['proveedor_telefono2']; } ?></td>
