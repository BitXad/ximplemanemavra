...
<input type="hidden" name="area_id" id="area_id" value="<?= (isset($area_id) ? $area_id : 0) ?>" />
<!----------------------------- script buscador --------------------------------------->
...
<?php }else{ ?>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4">
                    <table>
                        <tr>
                            <td style="width: 15%" class="text-right"><b>Total:&nbsp;</b></td>
                            <td style="width: 85%"><span id="eltotal_<?= $produccion['detproduccion_id'] ?>"></span></td>
                        </tr>
                        <tr>
                            <td style="width: 15%" class="text-right"><b>Perdida:&nbsp;</b></td>
                            <td style="width: 85%"><span id="laperdida_<?= $produccion['detproduccion_id'] ?>"></span>
                                <?php
                                /*if($produccion['produccion_fin'] != "" && $produccion['produccion_fin'] != null && $produccion['produccion_fin'] != "0000-00-00" ){
                                    echo date("d/m/Y", strtotime($produccion['produccion_fin']));
                                }*/
                        ...
                        <tr>
                            <td style="width: 15%" class="text-right"><b>Saldo:&nbsp;</b></td>
                            <td style="width: 85%"><span id="elsaldo_<?= $produccion['detproduccion_id'] ?>"></span></td>
                        </tr>
                    </table>
                </div>
                <div class="col-md-4">
                    <table>
                        ...
                        <tr>
                            <td style="width: 15%" class="text-right"><b>Area:&nbsp;</b></td>
                            <td style="width: 85%"><span id="area_info"></span><?= $produccion['area_nombre'] ?></td>
                        </tr>
                        <tr>
                            <td style="width: 15%" class="text-right"><b>Descripción:&nbsp;</b></td>
                            <td style="width: 85%"><span id="descripcion_area"><?= $produccion['area_descripcion'] ?></span></td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                <!-- <section id="platabandas_produccion" class="row"></section> -->
                <section class="col-md-12" id="info_platabanda_<?= $produccion['detproduccion_id'] ?>"></section>
                <hr class="col-md-12">
                <a href="<?= base_url("control_inventario/platabandas_produccion/$produccion_id"); ?>" class="btn btn-danger"><i class="fa fa-chevron-circle-left" aria-hidden="true"></i> Volver</a>
            </div>
        </div>
