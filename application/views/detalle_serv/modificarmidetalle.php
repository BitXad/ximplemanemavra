        ...
        function fetch_select(id_cat){
                ...
                $.each(results, function(index, value) {
                    ...
                    /*subcat = "<select name='subcatserv_id' class='form-control' id='subcatserv_id' onchange='ponerdescripcion(this.value)'>"+
                            "<option value=''>- MARCA/MODELO -</option>"+subcat+"</select>"*/
                      subcat = "<select name='subcatserv_id' class='form-control' id='subcatserv_id' onchange='ponerdescripcion(this.value)'>"+
...
<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('detalle_serv/modificarmidetalle/'.$servicio['servicio_id'].'/'.$detalle_serv['detalleserv_id']); ?>
			<div class="box-body">
			...
			<i class="fa fa-check"></i> Guardar
                ...
                <a href="<?php echo site_url('servicio/serview/'.$servicio['servicio_id']); ?>" class="btn btn-danger">
