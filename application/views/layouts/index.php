...
<!-- geo chart -->
    ...
    <!--<script src="lib/html5shiv/html5shiv.js"></script>-->
     <!-- Chartinator  -->
    <script src="<?php echo base_url('resources/js/chartinator.js');?>" ></script>
    <script type="<?php echo base_url('resources/text/javascript');?>">
        jQuery(function ($) {
...
<!--skycons-icons-->
<script src="<?php echo base_url('resources/js/skycons.js');?>"></script>
<!--//skycons-icons-->
</head>
<body>	
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
                                                                    <a href="<?php echo base_url(); ?>"> <h1>Ximpleman</h1> 
								...
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="<?php echo base_url('resources/images/p4.png');?>" alt=""></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img src="<?php echo base_url('resources/images/p2.png');?>" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img src="<?php echo base_url('resources/images/p3.png');?>" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
...
<div class="chart-layer-2">
	...
	<div class="col-md-6 chart-layer2-right">
	        ...
	        <div class='bar_group'>
				...
				<script src="<?php echo base_url('resources/js/bars.js');?>"></script>
...
<div class="copyrights">
	 <p>© 2018 Password SRL| Ingenieria Hardware & Software. All Rights Reserved <a href="http://www.passwordbolivia.com/" target="_blank">Password SRL</a> </p>
</div>	
