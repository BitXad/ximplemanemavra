...
function inicio(){
    ...
    resultadodetalleserviciohistorial(cliente_id);
}
...
function resultadodetalleserviciohistorial(cliente_id){
    var base_url    = document.getElementById('base_url').value;
    ...
    var controlador = base_url+"detalle_serv/get_historial_cliente";
    $.ajax({url: controlador,
           type:"POST",
            ...
            success:function(resul){
                ...
                if (registros != null){
                    ...
                    for (var i = 0; i < n ; i++){
                        ...
                        html += "</div>";
                        html += "<form action='"+base_url+"detalle_serv/nuevodetallehistorialc/"+registros[i]["detalleserv_id"]+"' method='post' accept-charset='utf-8'>";
                        ...
                        html += "<option value=''>- MARCA/MODELO -</option>";
                        ...
                        html += "<!------------------------------------------------------------------->";
                        html += "<input type='hidden' name='parafinalizar"+registros[i]["detalleserv_id"]+"' value='0' class='form-control' id='parafinalizar"+registros[i]["detalleserv_id"]+"' />";
                        html += "</div>";
                        html += "<div class='modal-footer aligncenter'>";
                        html += "<button type='submit' onclick='inputhidden("+registros[i]["detalleserv_id"]+")' class='btn btn-soundcloud'>";
                        html += "<i class='fa fa-check'></i> Guardar y Finalizar";
                        html += "</button>";
                        html += "<button type='submit' class='btn btn-success'>";
                        html += "<i class='fa fa-check'></i> Guardar y Continuar";
                        html += "</button>";
...
function inputhidden(detalleserv_idant){
    $('#parafinalizar'+detalleserv_idant).val(detalleserv_idant);
}
