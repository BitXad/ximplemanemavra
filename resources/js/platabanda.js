            ...
            resp['respuesta'].forEach(e => {
                ...
                html+=`<div class="col-xs-12 col-sm-6 col-md-3">
                            <div class="small-box ${color}">
                                <div class="inner">
                                    <span style="font-size: 8pt;"><b>Platabanda: </b>${i}<a style="float:right; cursor:pointer; color:${e['estado_id'] == 38 ? "":"#00019E"}" onclick="cambiar_estado_platabanda(${e['controli_id']},${e['estado_id']})"><i class="fa fa-toggle-${estado}" aria-hidden="true"></i></a></span><br>
                                    ${info}
                                    <br>
                                    <br>
                                    <br>
...
function form_costo(detproduccion_id){
        ...
        success:(result)=>{
            ...
            html +=             `</select>
                            ...
                            <div class="form-group" mb-2 ml-2>
                                <button class="btn btn-sm btn-success" title="Guardar" onclick="add_form(${detproduccion_id})"><i class="fa fa-floppy-o" aria-hidden="true"></i></button>
...
function add_form(detproduccion_id){
