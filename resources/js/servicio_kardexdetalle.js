...
function inicio(){
    ...
    resultadodetalleserviciokardex(servicio_id, codigo);
       /* tablaresultados(1);
        tablaproductos();
        */
}
...
function resultadodetalleserviciokardex(servicio_id, codigo){
    var base_url    = document.getElementById('base_url').value;
            ...
            success:function(resul){
                ...
                if (registros != null){
                    ...
                    for (var i = 0; i < n ; i++){
                        ...
                        html += "<label>Producto:"+registros[i]["detalleserv_codigo"]+" Registrar al Servicio N° "+servicio_id+"</label>";
                        html += "<button type='button' class='close' data-dismiss='modal' aria-label='Close'><span aria-hidden='true'>x</span></button>";
                        html += "</div>";
                        html += "<form action='"+base_url+"detalle_serv/nuevodetalle1/"+servicio_id+"' method='post' accept-charset='utf-8'>";
                        ...
                        html += "</div>";
                        html += "</div>";
                        html += "<input type='hidden' name='servicio_id' value='"+servicio_id+"' class='form-control' id='servicio_id' />";
